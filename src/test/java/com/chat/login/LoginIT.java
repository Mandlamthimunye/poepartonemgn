...
public class LoginIT {
    ...
    /**
     * Test of generateUniqueMessageId method, of class Login.
     */
    @Test
    public void testGenerateUniqueMessageId() {
        System.out.println("generateUniqueMessageId");
        String recipient = "";
        int counter = 0;
        String expResult = "";
        String result = Login.generateUniqueMessageId(recipient, counter);
        assertEquals(expResult, result);
        // TODO review the generated test code and remove the default call to fail.
        fail("The test case is a prototype.");
    }
    ...
    /**
     * Test of messagingMenu method, of class Login.
     */
    @Test
    public void testMessagingMenu() {
        System.out.println("messagingMenu");
        Scanner userInput = null;
        Login.messagingMenu(userInput);
        // TODO review the generated test code and remove the default call to fail.
        fail("The test case is a prototype.");
    }
